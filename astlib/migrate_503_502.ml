...
and copy_function_param_desc :
  Ast_503.Parsetree.function_param_desc -> Ast_502.Parsetree.function_param_desc =
  function
  | Ast_503.Parsetree.Pparam_val (l,e,p) ->
    Ast_502.Parsetree.Pparam_val ( copy_arg_label l
...
and copy_function_body :
  ...
  function
  | Ast_503.Parsetree.Pfunction_body e -> Ast_502.Parsetree.Pfunction_body (copy_expression e)
  | Ast_503.Parsetree.Pfunction_cases (cases, loc, attributes) ->
    Ast_502.Parsetree.Pfunction_cases (List.map copy_case cases, copy_location loc, copy_attributes attributes)
...
and copy_value_binding :
 ...
 fun {
     ...
     } ->
  {
    ...
    Ast_502.Parsetree.pvb_constraint = Option.map copy_value_constraint pvb_constraint;
...
and copy_value_constraint : Ast_503.Parsetree.value_constraint -> Ast_502.Parsetree.value_constraint
    =
    function
